...
RASTERTOBECLIPPED = 'D:/WilliamLidberg/FeatureExtraction/ElevationAboveStream/EAS10haMosaic/EAS10ha.tif' #change this to the raster that shoud be clipped.
CLIPPED_RASTERS = 'D:/WilliamLidberg/FeatureExtraction/Completed_Features/EAS10ha/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'D:/WilliamLidberg/FeatureExtraction/ElevationAboveStream/EAS10haMosaic/EAS10ha.tif' #Raster mosaic to be clipped

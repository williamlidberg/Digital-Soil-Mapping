...
RASTERTOBECLIPPED = 'D:/WilliamLidberg/Data/GIS/Deglaciation/Deglac32bit2m.tif' #change this to the raster that shoud be clipped.
CLIPPED_RASTERS = 'D:/WilliamLidberg/FeatureExtraction/Deglaciation/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'D:/WilliamLidberg/Data/GIS/Deglaciation/Deglac32bit2m.tif' #Raster mosaic to be clipped

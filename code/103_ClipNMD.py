...
RASTERTOBECLIPPED = 'D:/WilliamLidberg/FeatureExtraction/NMD2m/NDMResample2m.tif' #change this to the raster that shoud be clipped.
CLIPPED_RASTERS = 'D:/WilliamLidberg/FeatureExtraction/Completed_Features/NMD/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'D:/WilliamLidberg/FeatureExtraction/NMD2m/NDMResample2m.tif' #Raster mosaic to be clipped

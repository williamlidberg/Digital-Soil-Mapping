...
RASTERTOBECLIPPED = 'D:/WilliamLidberg/FeatureExtraction/Soil/SplitSoilRaster/soil.vrt' #change this to the raster that shoud be clipped.
CLIPPED_RASTERS = 'D:/WilliamLidberg/FeatureExtraction/Completed_Features/SoilMap/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'D:/WilliamLidberg/FeatureExtraction/Soil/SplitSoilRaster/soil.vrt' #Raster mosaic to be clipped

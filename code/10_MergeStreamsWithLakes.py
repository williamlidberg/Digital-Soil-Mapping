...
class workerThread(threading.Thread):
    ...
    def run(self):
        ...
        base = DEMS + self.file
        cellsize = 'None'
        args1 = ['--input="' + waterpolygons + '"', '--field="' + fieldname + '"', '--output="' + rasterlakes + '"', '--base="' + base + '"'] 
        ...
        merged1ha = COMBINED_1ha + self.file.replace('.dep', '.tif')
        merged5ha = COMBINED_5ha + self.file.replace('.dep', '.tif')
        merged10ha = COMBINED_10ha + self.file.replace('.dep', '.tif')
        merged20ha = COMBINED_20ha + self.file.replace('.dep', '.tif')

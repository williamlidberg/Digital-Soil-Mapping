...
CLIPPED_RASTERS = 'D:/WilliamLidberg/FeatureExtraction/Completed_Features/EAS1ha/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'D:/WilliamLidberg/FeatureExtraction/ElevationAboveStream/EAS1haMosaic/EAS1ha.tif' #Raster mosaic to be clipped

...
RUGGED = 'D:/WilliamLidberg/FeatureExtraction/RuggednessIndex/'
...
class workerThread(threading.Thread):
    ...
    def run(self):
        ...
        #Output files
        outputRUGGED = RUGGED + self.file

        
        #Arguments

        args1 = ['--input="' + inputdem + '"',  '--output="' + outputRUGGED + '"']

        try:
            wbt.run_tool('RuggednessIndex', args1, callback)

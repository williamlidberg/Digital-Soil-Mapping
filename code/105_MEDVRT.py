...
RASTERTOBECLIPPED = 'D:/WilliamLidberg/FeatureExtraction/Completed_Features/MaxElevationDeviation/MED.vrt' #change this to the raster that shoud be clipped.
CLIPPED_RASTERS = 'D:/WilliamLidberg/FeatureExtraction/Completed_Features/MaxElevationDeviation/' #path to output folder were clipped rasters will be saved
...
for file in os.listdir(LIDARSQUARES):
    if file.endswith('.tif'):
        ...
        in_raster = 'D:/WilliamLidberg/FeatureExtraction/Completed_Features/MaxElevationDeviation/MED.vrt' #Raster mosaic to be clipped
        ...
        try:
            ...
            arcpy.management.Clip(in_raster, clippextent, out_raster, in_template_dataset, "15", "#", "MAINTAIN_EXTENT")
        except:

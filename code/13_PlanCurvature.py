...
PlanCurvature = 'D:/WilliamLidberg/FeatureExtraction/PlanCurvature/'
...
class workerThread(threading.Thread):
    ...
    def run(self):
        ...
        #Output files
        outputPlanCurvature = PlanCurvature + self.file
       

        
        #Arguments

        args1 = ['--dem=' + inputdem, '--output=' + outputPlanCurvature]

        try:
            wbt.run_tool('PlanCurvature', args1, callback)

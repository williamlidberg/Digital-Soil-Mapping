...
SDOS = 'D:/WilliamLidberg/FeatureExtraction/SDOS/'
...
class workerThread(threading.Thread):
    ...
    def run(self):
        ...
        #Output files
        outputSDOS = SDOS + self.file

        
        #Arguments

        args1 = ['--input="' + inputdem + '"',  '--output="' + outputSDOS + '"', '--zfactor="' + '1'+ '"', '--filterx="' + '3'+ '"', '--filtery="' + '3'+ '"']

        try:
            wbt.run_tool('StandardDeviationOfSlope', args1, callback)
